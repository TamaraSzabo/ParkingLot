...
<t:pageTemplate pageTitle="Edit Car">
          ...
          <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPAth}/EditCar">
              <div class="row">
               ...
               <div class="row">
                  <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" id="license_plate" name="parking_spot" placeholder="Parking Spot"  required value="${car.parkingSpot}"/>
                      <div class="invalid-feedback">
            ...
            <p><a class="btn btn-primary btn-lg" href="https://getbootstrap.com/docs/4.0/examples/jumbotron/#" role="button">Edit Car</a></p>
